...
/* harmony import */ var _util_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8953);
/* harmony import */ var tesseract_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4995);
...
class Scrapper {
   ...
   async scroll_to_end() {
      while (!get_next_btn().classList.contains('opacity-30')) {
         ...
         await (0,_util_common_js__WEBPACK_IMPORTED_MODULE_0__/* .delay */ .cb)(10)
      }
   }
   ...
   async scroll_next_chapter() {
      ...
      while (Date.now() - start < timeout) {
         if (document.body.innerHTML !== cur_page && get_next_btn())
            return true
         await (0,_util_common_js__WEBPACK_IMPORTED_MODULE_0__/* .delay */ .cb)(200)
      }
      return false
   }
   ...
   async create_workers(n, sheduler) {
      for (let i = 0; i < n; i++)
         sheduler.addWorker(await (0,tesseract_js__WEBPACK_IMPORTED_MODULE_1__.createWorker)('kor'))
   }
   ...
   async parse_img(start = 1, end = 10000) {
      ...
      const scheduler = (0,tesseract_js__WEBPACK_IMPORTED_MODULE_1__.createScheduler)();
   ...
   async run() {
      await (0,_util_common_js__WEBPACK_IMPORTED_MODULE_0__/* .delay */ .cb)(2000) // avoid save prev. chapter data
      let paragraphs;
...
/* harmony export */ });
/* unused harmony exports escapeRegexChars, getRegFromString, urlToRegex, tokenToRegex, load, types, get_type, isDict, isArray, isString, isInt, isUrl, isImage, isNull, isUnknown, isEmpty, rnd_from_arr, rnd_key_from_obj, toArr, get_pct_diff, obj_true_length, merge_obj, are_obj_equal */
...
/******/ 	var __webpack_exports__ = __webpack_require__(5336);
/******/ 	
/******/ })()
;
};